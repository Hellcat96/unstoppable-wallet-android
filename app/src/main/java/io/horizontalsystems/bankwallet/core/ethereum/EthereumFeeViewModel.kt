...
class EthereumFeeViewModel(
    ...
    fun formatGasPrice(gasPrice: GasPrice): String {
        return App.numberFormatter.format(convert(gasPrice.value, gasPrice.unit, Unit.GWEI), 0, 2, suffix = " ${Unit.GWEI.title}")
    }
...
//data class GasDataViewItem(
//    val gasLimit: Long,
//    val gasPrice: GasPrice,
//    val unit: GasData.Unit = GasData.Unit.GWEI
//)
